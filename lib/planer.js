...
(function() {
  ...
  exports.extractFrom = function(msgBody, contentType, dom, removeFwd) {
    if (contentType == null) {
  ...
  exports.extractFromPlain = function(msgBody, removeFwd) {
  ...
  exports.extractFromHtml = function(msgBody, dom, removeFwd) {
  ...
  exports.processMarkedLines = function(lines, markers, returnFlags, removeFwd) {
    var endCutIdx, endIdx, fwdMsgMatch, inlineMatchRegex, inlineReplyIndex, inlineReplyMatch, isInlineReplyLink, matchValue, quotationEnd, quotationMatch, startIds;
    if (returnFlags == null) {
      returnFlags = {};
    }
